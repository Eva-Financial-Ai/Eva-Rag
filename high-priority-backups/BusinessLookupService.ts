...
export class BusinessLookupService {
  ...
  private async searchStateRegistry(
    ...
    try {
      ...
      console.error(`Error searching ${stateCode}:`, error);
      return [];
    }
  }
  ...
  private async searchStateAPI(
    ...
    for (const term of searchTerms) {
      try {
        ...
        console.error(`API search error for ${stateCode}:`, error);
      }
    }
  ...
  private async downloadStateDocuments(
    ...
    try {
      ...
      console.error(`Error downloading documents for ${stateCode}:`, error);
    }
  ...
  private async storeResults(
    ...
    try {
      ...
      console.error('Error storing records in Supabase:', error);
    }
  ...
  private async parseWebScrapingResults(stateCode: string, data: any): Promise<BusinessRecord[]> {
  ...
  private async storeInVectorDB(vectorData: any): Promise<void> {
