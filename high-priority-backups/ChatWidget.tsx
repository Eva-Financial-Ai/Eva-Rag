...
const ChatWidget: React.FC<ChatWidgetProps> = ({
  ...
  useEffect(() => {
    ...
    debugLog('general', 'log_statement', '[ChatWidget] Received messages prop:', activeConversationMessages)
    debugLog('general', 'log_statement', '[ChatWidget] Current agent prop:', currentSelectedAgent)
                ...
                >
                  {message.sender === 'user' ? (
                    ...
                    <div className="max-w-[70%]">
                      ...
                      <div className="bg-white rounded-lg p-5 text-gray-800 shadow-sm text-lg">
                            ...
                            {message.bulletPoints.map((point, index) => (
                              <button
                                ...
                                className="w-full text-left py-3 px-4 bg-gray-50 rounded-md hover:bg-gray-100
                                         transition-colors border border-gray-200 text-lg"
                              >
                                {point}
                              </button>
                            ))}
