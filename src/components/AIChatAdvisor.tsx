...
Would you like to view a summary of the orchestrated data or proceed with analysis?`,
  ...
  const renderFileAttachment = (file: File, index: number) => {
    ...
    return (
      <div key={index} className="bg-gray-50 mb-2 flex items-center rounded-lg p-2">
        <div className="bg-gray-200 mr-2 flex h-8 w-8 flex-shrink-0 items-center justify-center rounded">
          {isImage ? (
            <svg
    ...
    return (
      <div className="mt-2 space-y-2">
        {attachments.map((attachment, index) => (
          <div key={index} className="bg-gray-100 flex items-center rounded-md p-2">
            <div className="bg-gray-200 mr-2 flex h-8 w-8 flex-shrink-0 items-center justify-center rounded">
  ...
  return (
    <>
      ...
      {!isOpen && (
        <button
          onClick={openChat}
          className="text-white fixed bottom-8 right-8 z-30 flex items-center justify-center rounded-full bg-primary-600 p-4 shadow-lg transition-all duration-200 hover:bg-primary-700"
      ...
      {isOpen && (
        <div
          ref={chatRef}
          className={`fixed z-20 overflow-hidden rounded-lg shadow-xl transition-all duration-300 ${
            minimized ? 'bottom-8 right-8 h-20 w-96 bg-primary-600' : ''
          }`}
          style={{
        ...
        >
          ...
          {!minimized && (
            <>
              ...
              >
                <div className="absolute left-1 top-1 h-2 w-2 rounded-full bg-gray-400"></div>
              </div>
              ...
              >
                <div className="absolute right-1 top-1 h-2 w-2 rounded-full bg-gray-400"></div>
              </div>
              ...
              >
                <div className="absolute bottom-1 left-1 h-2 w-2 rounded-full bg-gray-400"></div>
              </div>
              ...
              >
                <div className="absolute bottom-1 right-1 h-2 w-2 rounded-full bg-gray-400"></div>
              </div>
            </>
          )}
          ...
          {minimized ? (
            <div className="flex h-full w-full items-center justify-between">
              <div
                className="flex flex-grow cursor-pointer items-center space-x-3 p-3"
                onClick={expandChat}
              >
              ...
              <div className="flex items-center space-x-2 pr-3">
                <button
                  onClick={expandChat}
                  className="rounded-md p-1.5 transition-colors hover:bg-primary-500"
            ...
            <div
              className="text-white flex cursor-move items-center justify-between bg-primary-600 px-4 py-3"
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <span className="text-lg font-medium">EVA AI Advisor</span>
              ...
              <div className="flex items-center">
                <div className="relative mr-2">
                  <select
                    ...
                    className="text-white appearance-none rounded-md bg-primary-500 py-1 pl-3 pr-8 text-sm focus:outline-none focus:ring-2 focus:ring-primary-300"
          ...
          {!minimized && (
            <div className="bg-white flex h-[calc(100%-3.5rem)] flex-col">
              {/* Context Dropdowns */}
              <div className="bg-gray-50 flex items-center space-x-2 border-b border-gray-200 p-3">
                <div className="relative w-1/2">
                  <label htmlFor="customer-select" className="mb-1 block text-xs text-gray-600">
                    Customer Context:
                  </label>
                  <select
                    id="customer-select"
                ...
                <div className="relative w-1/2">
                  <label htmlFor="transaction-select" className="mb-1 block text-xs text-gray-600">
                    Transaction Context:
                  </label>
                  <select
              ...
              <div className="bg-white flex flex-grow flex-col overflow-y-auto p-4">
                ...
                {isLoading && (
                  <div className="mb-4 self-start">
                    <div className="bg-gray-100 flex space-x-2 rounded-lg p-4 text-gray-800 shadow-sm">
                      <div className="h-2.5 w-2.5 animate-bounce rounded-full bg-gray-500"></div>
                      <div className="h-2.5 w-2.5 animate-bounce rounded-full bg-gray-500 delay-100"></div>
                      <div className="h-2.5 w-2.5 animate-bounce rounded-full bg-gray-500 delay-200"></div>
                    </div>
                  </div>
                )}
              ...
              <div className="flex-shrink-0">
                ...
                <div className="bg-gray-50 overflow-x-auto border-t border-gray-200 p-3">
                  <p className="mb-2 ml-1 text-xs text-gray-500">Suggested questions:</p>
                  <div className="flex space-x-3 px-1">
                    {EXAMPLE_PROMPTS.map((prompt, index) => (
                      <button
                        key={index}
                        onClick={() => handlePromptClick(prompt)}
                        className="bg-white flex-shrink-0 whitespace-nowrap rounded-full border border-gray-300 px-4 py-1.5 text-sm text-gray-600 hover:bg-gray-100 hover:text-primary-600"
                      >
                        {prompt}
                      </button>
                    ))}
                  ...
                  <div className="flex">
                    <div className="relative flex-grow">
                      <textarea
                        ...
                        className="max-h-[120px] min-h-[48px] w-full resize-none rounded-lg border border-gray-300 p-3 text-base focus:border-transparent focus:outline-none focus:ring-2 focus:ring-primary-500"
                        style={{ height: '48px' }}
                        rows={1}
                      />
                    </div>

                    <div className="ml-3 flex items-end space-x-2">
                      {/* File upload button */}
                      <button
                        onClick={triggerFileUpload}
                        className="bg-gray-100 rounded-full p-3 text-gray-600 transition-colors hover:bg-gray-200"
