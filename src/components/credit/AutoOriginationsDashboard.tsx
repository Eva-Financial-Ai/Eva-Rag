...
const generateKPIData = (userType: string, transactions: Record<string, unknown>[]) => {
...
// Fix the KPI component props interface
...
const KPICard: React.FC<KPICardProps> = ({ kpi, data, userType }) => {
  ...
  const formatKPIValue = (value: any, type: string) => {
  ...
  return (
    <div
      className={`bg-white rounded-lg border-l-4 p-6 shadow ${colorClasses[kpi.color]} transition-shadow duration-200 hover:shadow-lg`}
    >
        ...
        <div className="flex items-center">
          ...
          <div className="ml-4">
            ...
            <p className="text-2xl font-bold text-gray-900">
              {formatKPIValue(data.value, kpi.key)}
            </p>
          </div>
        </div>
        <div className="flex items-center">
...
const AutoOriginationsDashboard = () => {
  ...
  const kpiData = generateKPIData(
    currentUserType,
    transactions.map(t => ({ ...t, amount: Number(t.amount) || 0 })) as unknown as Record<
      string,
      unknown
    >[],
  );
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-4">
                <button
                  ...
                  className="text-white flex items-center rounded-lg bg-blue-600 px-4 py-2 hover:bg-blue-700"
                >
