                  ...
                  {files.map(file => (
                    ...
                    >
                      ...
                      <div className="mt-3 flex space-x-2">
                        <button
                          onClick={() => toast.info('Document viewer will open here')}
                          className="flex-1 rounded bg-blue-600 px-3 py-1.5 text-xs text-white hover:bg-blue-700"
                        >
                          View
                        </button>
                        <button
                          onClick={() => toast.info('AI chat will open here')}
        ...
        <div className="mt-4 rounded-lg bg-white p-4 shadow">
          ...
          <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
            <button
              onClick={() =>
                toast.info(
                  'Document FAQ: What documents are typically required for an equipment loan application?',
                )
              }
            ...
            <button
              onClick={() =>
                toast.info(
                  'Document Guide: How should I prepare financial statements for a business loan application?',
                )
              }
              className="flex items-center justify-between rounded-md border p-3 text-left text-sm hover:bg-gray-50"
            >
            ...
            <button
              onClick={() =>
                toast.info(
                  'AI Analysis: Can you analyze if the provided documentation is sufficient for approval?',
                )
              }
              className="flex items-center justify-between rounded-md border p-3 text-left text-sm hover:bg-gray-50"
            >
